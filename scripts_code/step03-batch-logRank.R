...
load( file = 
        file.path(Rdata_dir,'TCGA-KIRC-miRNA-clinical.Rdata')
)
dim(expr)
dim(meta)
...
ggsurvplot(sfit,palette = "aaas",title="BLOC1S1 KIRC",
           risk.table =TRUE,pval =TRUE,xlab ="Time(days)",surv.plot.height=1)
