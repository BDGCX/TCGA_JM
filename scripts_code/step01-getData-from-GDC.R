...
library("XML")
library("methods")
#读取临床信息矩阵，dir为所要读取的文件所在的路径
dir="/Users/bdgcx/OneDrive/Rdata/TCGA/gdc_download_clinical_20210805_131201.744656/"
if(dir.exists(dir)){
  ...
  save(cl_df,file = 'GDC_TCGA_KIRC_clinic_df.Rdata')
  
#读取RNA-seq表达矩阵
  dir="/Users/bdgcx/OneDrive/Rdata/TCGA/gdc_download_RNA-seq_20210805_122926/"
  ...
  mi_df[1:4,1:4]
  save(mi_df,file = 'GDC_TCGA_KIRC_RNA-seq_df.Rdata')
